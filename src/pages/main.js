...
const MainPage = () => {  
  ...
  <div className="button-container"><a className = "bigBut" href="https://weatherappbc2023.netlify.app/" target="_blank" rel="noreferrer">Weather App (new tab)</a></div>
  </CCarouselItem>
  <CCarouselItem className="caraItem">
  ...
  <div className="button-container"><a className = "bigBut" href="https://todotodos.netlify.app/" target="_blank" rel="noreferrer">To do App (new tab)</a></div>
  </CCarouselItem>
  <CCarouselItem className="caraItem">
  ...
  <div className="button-container"><a className = "bigBut" href="https://play-card-games.netlify.app" target="_blank" rel="noreferrer">Card Games (new tab)</a></div>
  </CCarouselItem>
  <CCarouselItem className="caraItem">
  ...
  <div className="button-container"><a className = "bigBut" href="https://punkipa.netlify.app/" target="_blank" rel="noreferrer">PunkIPA App (new tab)</a></div>
  </CCarouselItem>
</CCarousel>
</div>
</div>
