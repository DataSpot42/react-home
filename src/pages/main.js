...
const MainPage = () => {  
  ...
  <div className="button-container"><Link to='/WeatherApp' className = "mainNavItem"><span className='linkN'>WeatherApp (in window)</span></Link><a className = "mainItem" href="https://weatherappbc2023.netlify.app/" target="_blank" rel="noreferrer">Weather App (new tab)</a></div>
  </CCarouselItem>
  <CCarouselItem className="caraItem">
  ...
  <div className="button-container"><Link to='/TodoApp' className = "mainNavItem"><span className='linkN'>To Do App (in window)</span></Link><a className = "mainItem" href="https://todotodos.netlify.app/" target="_blank" rel="noreferrer">To do App (new tab)</a></div>
  </CCarouselItem>
  <CCarouselItem className="caraItem">
  ...
  <div className="button-container"><Link to='/CardGamesApp' className = "mainItem"><span className='linkMain'>Card Games (in window)</span></Link><a className = "mainItem" href="https://play-card-games.netlify.app" target="_blank" rel="noreferrer">Card Games (new tab)</a></div>
  </CCarouselItem>
</CCarousel>
</div>
</div>
